...
## 1。解决“身份映射”<div id = "s1"></div>

-   [\[CVPR 2025\]](https://openaccess.thecvf.com/content/CVPR2025/html/Guo_Dinomaly_The_Less_Is_More_Philosophy_in_Multi-Class_Unsupervised_Anomaly_CVPR_2025_paper.html)**DINOMALY：多级无监督的异常检测中的哲学越少**[：Octocat：](https://github.com/guojiajeremy/dinomaly)

    _Guo, Jia and Lu, Shuai and Zhang, Weihang and Chen, Fang and Li, Huiqi and Liao, Hongen_
...
-   \*[\[神经2022\]](https://proceedings.neurips.cc/paper_files/paper/2022/file/1d774c112926348c3e25ea47d87c835b-Paper-Conference.pdf)**多级异常检测的统一模型**[：Octocat：](https://github.com/zhiyuanyou/uniad)

    _You, Zhiyuan and Cui, Lei and Shen, Yujun and Yang, Kai and Lu, Xin and Zheng, Yu and Le, Xinyi_
...
## 2。有监督的学习<div id = "s2"></div>

-   \*[\[CVPR 2024\]](https://openaccess.thecvf.com/content/CVPR2024/html/Baitieva_Supervised_Anomaly_Detection_for_Complex_Industrial_Images_CVPR_2024_paper.html)**监督复杂工业图像的异常检测**[：Octocat：](https://github.com/abc-125/segad)
...
-   [\[CVPR 2019\]](https://openaccess.thecvf.com/content_CVPR_2019/papers/Zhang_Cascaded_Generative_and_Discriminative_Learning_for_Microcalcification_Detection_in_Breast_CVPR_2019_paper.pdf)**在乳房乳房X线照片中检测微钙化检测的级联生成和歧视性学习**

    _Zhang, Fandong and Luo, Ling and Sun, Xinwei and Zhou, Zhen and Li, Xiuli and Yu, Yizhou and Wang, Yizhou_
...
## 3。自学学习<div id = "s3"></div>

-   \*[\[TPAMI 2024\]](https://ieeexplore.ieee.org/abstract/document/10553645/)**MOODV2：分布外检测的掩盖图像建模**[：Octocat：](https://github.com/dvlab-research/MOOD)

    _Li, Jingyao and Chen, Pengguang and Yu, Shaozuo and Liu, Shu and Jia, Jiaya_
...
-   \*[\[CVPR 2023\]](http://openaccess.thecvf.com/content/CVPR2023/html/Li_Rethinking_Out-of-Distribution_OOD_Detection_Masked_Image_Modeling_Is_All_You_CVPR_2023_paper.html)**Rethinking Out-of-Distribution (OOD) Detection: Masked Image Modeling Is All You Need**[：Octocat：](https://github.com/dvlab-research/MOOD)
    ...
    _Li, Jingyao and Chen, Pengguang and He, Zexin and Yu, Shaozuo and Liu, Shu and Jia, Jiaya_
...
-   [\[媒体2023\]](https://arxiv.org/pdf/2301.08330)**噪声在医学图像中异常检测模型中的作用**[：Octocat：](https://github.com/antanaskascenas/denoisingae)
...
-   [\[MICCAI 2024\]](https://arxiv.org/pdf/2403.09303)**从理论角度重新考虑自动编码器以进行医学异常检测**[：Octocat：](https://github.com/caiyu6666/ae4ad)

    _Cai, Yu and Chen, Hao and Cheng, Kwang-Ting_
...
_Zhao, Yuzhong and Ding, Qiaoqiao and Zhang, Xiaoqun_
...
-   [\[神经计算2025\]](https://www.sciencedirect.com/science/article/pii/S0925231224015339)**通过循环一致的对抗网络进行工业和医学异常检测**[：Octocat：](https://github.com/valdelch/cyclegans-anomalydetection)

    _布格哈姆，情人节，情人，贝诺特，贝诺特。_
...
_Zhang, Wentian and Liu, Haozhe and Xie, Jinheng and Huang, Yawen and Zhang, Yu and Li, Yuexiang and Ramachandra, Raghavendra and Zheng, Yefeng_
...
_Xiang, Tiange and Zhang, Yixiao and Lu, Yongyi and Yuille, Alan L and Zhang, Chaoyi and Cai, Weidong and Zhou, Zongwei_
...
-   [\[媒体2019\]](https://www.sciencedirect.com/science/article/pii/S1361841518302640)**F-Anogan：使用生成对抗网络快速无监督的异常检测**[：Octocat：](https://github.com/A03ki/f-AnoGAN)
...
-   [\[IPMI 2017\]](https://link.springer.com/chapter/10.1007/978-3-319-59050-9_12)**使用生成对抗网络无监督的异常检测，以指导标记发现**[：Octocat：](https://github.com/seungjunlee96/AnoGAN-pytorch)
...
## 6。基于流的方法<div id = "s6"></div>

-   \*[\[CVPR 2023\]](https://openaccess.thecvf.com/content/CVPR2023/html/Lei_PyramidFlow_High-Resolution_Defect_Contrastive_Localization_Using_Pyramid_Normalizing_Flow_CVPR_2023_paper.html?ref=https://githubhelp.com)**金字塔流：使用金字塔归一化流量的高分辨率缺陷对比度定位**[：Octocat：](https://github.com/gasharper/PyramidFlow)

    _Lei, Jiarui and Hu, Xiaobo and Wang, Yue and Liu, Dong_
...
## 7。基于扩散的方法<div id = "s7"></div>

-   [\[CVPR 2025\]](https://arxiv.org/abs/2406.01078)**异常事物：迅速看不见的视觉异常产生**[：Octocat：](https://github.com/EPFL-IMOS/AnomalyAny)

    _Sun, Han and Cao, Yunkang and Dong, Hao and Fink, Olga_
...
-   [\[不确定2024\]](https://link.springer.com/chapter/10.1007/978-3-031-73158-7_11)**图像条件的扩散模型用于医学异常检测**
...
-   [\[CVPR 2022\]](https://openaccess.thecvf.com/content/CVPR2022W/NTIRE/papers/Wyatt_AnoDDPM_Anomaly_Detection_With_Denoising_Diffusion_Probabilistic_Models_Using_Simplex_CVPRW_2022_paper.pdf)**阳极：使用单纯形噪声的脱氧扩散概率模型的异常检测**[：Octocat：](https://github.com/julian-wyatt/anoddpm)

    _怀亚特（Wyatt），朱利安（Julian）和里奇（Leach），亚当（Adam）和施蒙（Schmon），塞巴斯蒂安（Sebastian）_
...
## 8。基于补丁的方法<div id = "s8"></div>

-   [\[MIDL 2024\]](https://proceedings.mlr.press/v227/behrendt24a/behrendt24a.pdf)**修补的扩散模型，用于脑MRI中无监督的异常检测**[：Octocat：](https://github.com/finnbehrendt/patched-diffusion-models-uad)
...
-   \*[\[CVPR 2021\]](https://openaccess.thecvf.com/content/CVPR2021/html/Wang_Glancing_at_the_Patch_Anomaly_Localization_With_Global_and_Local_CVPR_2021_paper.html?ref=https://githubhelp.com)**瞥了一眼贴片：具有全球和局部功能比较的异常定位**

    _Wang, Shenzhi and Wu, Liwei and Cui, Lei and Shen, Yujun_
...
-   [\[Inf。 Fusion 2025\]](https://www.sciencedirect.com/science/article/pii/S1566253524004093)**适应多模式视网膜异常检测和定位的段的任何模型**[：Octocat：](https://github.com/Jingtao-Li-CVer/MMRAD)

    _Li, Jingtao and Chen, Ting and Wang, Xinyu and Zhong, Yanfei and Xiao, Xuan_
...
-   [\[CVPR 2025\]](https://arxiv.org/pdf/2503.06661)**AA-CLIP：通过异常夹提高零射击异常检测**[：Octocat：](https://github.com/mwxinnn/aa-clip)

    _Ma, Wenxin and Zhang, Xu and Yao, Qingsong and Tang, Fenghe and Wu, Chenxu and Li, Yingtai and Yan, Rui and Jiang, Zihang and Zhou, S Kevin_
...
-   [\[MICCAI 2025\]](https://arxiv.org/abs/2503.01020)**通过医学视觉语言模型深入研究分布式检测**[：Octocat：](https://github.com/pyjulie/medical-vlms-ood-detection)

    _Ju, Lie and Zhou, Sijin and Zhou, Yukun and Lu, Huimin and Zhu, Zhuoting and Keane, Pearse A and Ge, Zongyuan_
...
-   [\[神经2024\]](https://proceedings.neurips.cc/paper_files/paper/2024/hash/8f4477b086a9c97e30d1a0621ea6b2f5-Abstract-Conference.html)**一到正常：用于几次异常检测的异常个性化**

    _Li, Yiyue and Zhang, Shaoting and Li, Kang and Lao, Qicheng_
...
-   [\[CVPR 2024\]](http://openaccess.thecvf.com/content/CVPR2024/papers/Zhu_Toward_Generalist_Anomaly_Detection_via_In-context_Residual_Learning_with_Few-shot_CVPR_2024_paper.pdf)**通过少量样本提示，通过围内剩余学习朝向通才异常检测**[：Octocat：](https://github.com/mala-lab/inctrl)

    _Zhu, Jiawen and Pang, Guansong_
...
_Huang, Chaoqin and Jiang, Aofan and Feng, Jinghao and Zhang, Ya and Wang, Xinchao and Wang, Yanfeng_
...
-   [\[ICLR 2024\]](https://openreview.net/forum?id=buC4E91xZE)**呼吸症：零射异常检测的对象不合时宜**[：Octocat：](https://github.com/zqhang/anomalyclip)

    _Zhou, Qihang and Pang, Guansong and Tian, Yu and He, Shibo and Chen, Jiming_
...
-   \*[\[ACM MM 2024\]](https://dl.acm.org/doi/abs/10.1145/3664647.3681376)**SIMCLIP：简单提示的图像文本对准零 - 零/少数异常检测**[：Octocat：](https://github.com/CH-ORGI/SimCLIP)

    _Deng, Chenghao and Xu, Haote and Chen, Xiaolu and Xu, Haodi and Tu, Xiaotong and Ding, Xinghao and Huang, Yue_
...
-   [\[MICCAI 2024\]](https://arxiv.org/pdf/2405.11315)**Mediclip：调整剪辑以进行几次医疗图像异常检测**[：Octocat：](https://github.com/cnulab/mediclip)

    _Zhang, Ximiao and Xu, Min and Qiu, Dehui and Yan, Ruixin and Lang, Ning and Zhou, Xiuzhuang_
...
-   \*[\[神经2022\]](https://proceedings.neurips.cc/paper_files/paper/2022/hash/e43a33994a28f746dcfd53eb51ed3c2d-Abstract-Conference.html)**通过视觉语言表示探索分布式检测**[：Octocat：](https://github.com/deeplearning-wisc/mcm)

    _Ming, Yifei and Cai, Ziyang and Gu, Jiuxiang and Sun, Yiyou and Li, Wei and Li, Yixuan_
...
## 11。知识蒸馏<div id = "s11"></div>

-   \*[\[AAAI 2025\]](https://arxiv.org/pdf/2412.07579)**解锁反向蒸馏以进行异常检测的潜力**[：Octocat：](https://github.com/hito2448/urd)

    _Liu, Xinyue and Wang, Jianyuan and Leng, Biao and Zhang, Shuo_
...
## 12。相关学习<div id = "s12"></div>

-   [\[TMI 2024\]](https://ieeexplore.ieee.org/document/10680612)**面对相似性的差异：胸部X射线异常检测的内部和相互关系的无监督学习**

    _Xu, Shicheng and Li, Wei and Li, Zuoyong and Zhao, Tiesong and Zhang, Bob_
...
## 13。异常产生<div id = "s13"></div>

-   \*[\[CVPR 2025\]](https://openaccess.thecvf.com/content/CVPR2025/html/Jin_Dual-Interrelated_Diffusion_Model_for_Few-Shot_Anomaly_Image_Generation_CVPR_2025_paper.html)**几次异常图像产生的双间隔扩散模型**[：Octocat：](https://github.com/yinyjin/DualAnoDiff)
...
## 14。基准<div id = "s14"></div>

-   [\[自然通讯2025\]](https://www.nature.com/articles/s41467-025-56321-y)**评估生成AI中的规范表示学习，以在脑成像中进行健壮的异常检测**[：Octocat：](https://github.com/compai-lab/2024-ncomms-bercea.git)
...
-   [\[媒体2025\]](https://arxiv.org/pdf/2404.04518)**中间：医学图像中异常检测的比较研究**[：Octocat：](https://github.com/caiyu6666/medianomaly)

    _Cai, Yu and Zhang, Weiwen and Chen, Hao and Cheng, Kwang-Ting_
...
-   [\[CVPR 2024\]](https://openaccess.thecvf.com/content/CVPR2024W/VAND/html/Bao_BMAD_Benchmarks_for_Medical_Anomaly_Detection_CVPRW_2024_paper.html)**BMAD：医疗异常检测的基准**[：Octocat：](https://github.com/dorisbao/bmad)

    _Bao, Jinan and Sun, Hanshi and Deng, Hanqiu and He, Yinsheng and Zhang, Zhaoxiang and Li, Xingyu_
...
-   [\[Arxiv 2024\]](https://www.researchgate.net/profile/Haoyang-He-7/publication/381190391_ADer_A_Comprehensive_Benchmark_for_Multi-class_Visual_Anomaly_Detection/links/66dffcb7f84dd1716ce10dc4/ADer-A-Comprehensive-Benchmark-for-Multi-class-Visual-Anomaly-Detection.pdf)**ADER：多级视觉异常检测的综合基准**[：Octocat：](https://github.com/zhangzjn/ader)

    _Zhang, Jiangning and He, Haoyang and Gan, Zhenye and He, Qingdong and Cai, Yuxuan and Xue, Zhucun and Wang, Yabiao and Wang, Chengjie and Xie, Lei and Liu, Yong_
