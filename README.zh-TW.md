...
**🦉貢獻者：[Y i肥sun (22' HD U-IT MO undergraduate)](https://diaoquesang.github.io/),[Jun好j IA (23' HD u undergraduate)](https://github.com/BeistMedAI),[ha oz恆 (22' HD U-IT MO undergraduate)](https://github.com/267588),[Zhang號Chen (21' HD U-IT MO undergraduate/25' s EU master)](https://benny0323.github.io/bio/),[Y U質he (23' XD u undergraduate)](https://github.com/Black0226),[jin紅Wang (21' ZJ u PhD)](https://wang-jinhong.github.io/),[jin城l i (23' NTU undergraduate)](https://github.com/li00000011).**

**🎓深維基：[單擊生成GitHub知識庫文檔](https://deepwiki.com/diaoquesang/Paper-List-for-Medical-Anomaly-Detection).**

**📦其他資源：[1][Bone Suppression in Chest X-Rays: A Deep Survey](<https://github.com/diaoquesang/A-detailed-summarization-about-bone-suppression-in-Chest-X-rays>),[2][A Paper List for Prototypical Learning](<https://github.com/BeistMedAI/Paper-List-for-Prototypical-Learning>),[3][A Paper List for Cell Detection](<https://github.com/li00000011/Paper-List-for-Cell-Detection>),[4][Medical-AI-Guide](<https://github.com/diaoquesang/Medical-AI-Guide/>),[5][Paper List for Medical Reasoning Large Language Models](<https://github.com/HovChen/Paper-List-for-Medical-Reasoning-Large-Language-Models>).**

### 歡迎通過聯繫加入我們：[szhsxhsyf@hdu.edu.cn](mailto:szhsxhsyf@hdu.edu.cn).
...
## 1。解決“身份映射”<div id = "s1"></div>

-   [\[CV PR 2025\]](https://openaccess.thecvf.com/content/CVPR2025/html/Guo_Dinomaly_The_Less_Is_More_Philosophy_in_Multi-Class_Unsupervised_Anomaly_CVPR_2025_paper.html)**DINOMALY：多級無監督的異常檢測中的哲學越少**[：Octocat：](https://github.com/guojiajeremy/dinomaly)

    _GU O, J IA and l U, S懷and Zhang, Wei行and Chen, fan Gan DL i, Hui奇and Liao, hon跟_
...
-   \*[\[神經2022\]](https://proceedings.neurips.cc/paper_files/paper/2022/file/1d774c112926348c3e25ea47d87c835b-Paper-Conference.pdf)**多級異常檢測的統一模型**[：Octocat：](https://github.com/zhiyuanyou/uniad)

    _you, Z Hi冤案DC UI, l EIA NDS很, Y U君and yang, Kai and l U, ξ NAND Z恆, yuan的LE, X in一_
...
## 2。有監督的學習<div id = "s2"></div>

-   \*[\[CV PR 2024\]](https://openaccess.thecvf.com/content/CVPR2024/html/Baitieva_Supervised_Anomaly_Detection_for_Complex_Industrial_Images_CVPR_2024_paper.html)**監督複雜工業圖像的異常檢測**[：Octocat：](https://github.com/abc-125/segad)

    _Baitieva，Aimira和Hurych，David和Besnier，Victor和Bernard，Olivier_
...
-   [\[CV PR 2019\]](https://openaccess.thecvf.com/content_CVPR_2019/papers/Zhang_Cascaded_Generative_and_Discriminative_Learning_for_Microcalcification_Detection_in_Breast_CVPR_2019_paper.pdf)**在乳房乳房X線照片中檢測微鈣化檢測的級聯生成和歧視性學習**

    _Zhang, fan動and luo, Lin Gan的sun, ξ N位and Zhou, Z很and l i, X IU李Andy U, Y I週and Wang, Y I軸_
...
## 3。自學學習<div id = "s3"></div>

-   \*[\[TPAMI 2024\]](https://ieeexplore.ieee.org/abstract/document/10553645/)**MOODV2：分佈外檢測的掩蓋圖像建模**[：Octocat：](https://github.com/dvlab-research/MOOD)

    _l i, jin更要and Chen, peng光Andy U, S好做and l IU, Shu安DJ IA, J IA呀_
...
-   \*[\[CV PR 2023\]](http://openaccess.thecvf.com/content/CVPR2023/html/Li_Rethinking_Out-of-Distribution_OOD_Detection_Masked_Image_Modeling_Is_All_You_CVPR_2023_paper.html)**重新思考分佈（OOD）檢測：蒙版的圖像建模就是您所需要的**[：Octocat：](https://github.com/dvlab-research/MOOD)

    _l i, jin更要and Chen, peng廣安的he, Z噁心Andy U, S好做and l IU, Shu安DJ IA, J IA呀_
...
-   [\[媒體2023\]](https://arxiv.org/pdf/2301.08330)**噪聲在醫學圖像中異常檢測模型中的作用**[：Octocat：](https://github.com/antanaskascenas/denoisingae)

    _Kascenas，Antanas和Sanchez，Pedro和Schrempf，Patrick and Wang，Chaoyang和Clackett，William和Mikhael，Shadia S和Voisey，Jeremy P和Goatman，Keith and Keith and Weir，Alexander和Pugeault，Nicolas等，其他_
...
-   [\[mic CAI 2024\]](https://arxiv.org/pdf/2403.09303)**從理論角度重新考慮自動編碼器以進行醫學異常檢測**[：Octocat：](https://github.com/caiyu6666/ae4ad)

    _CAI, yuan的Chen, H AO and Cheng, K王-ting_
...
_Zhao, Y U中and ding, Q IA o敲and Zhang, ξ AO群_
...
-   [\[神經計算2025\]](https://www.sciencedirect.com/science/article/pii/S0925231224015339)**通過循環一致的對抗網絡進行工業和醫學異常檢測**[：Octocat：](https://github.com/valdelch/cyclegans-anomalydetection)

    _布格哈姆，情人節，情人，貝諾特，貝諾特。_
...
_Zhang, wen天安DL IU, ha o這and X IE, jin橫and Huang, ya問and Zhang, yuan DLI, Y UE翔安drama Chandra, RA給Haven的RA and Z恆, Y E峰_
...
_ξ昂, Tia N個and Zhang, Y i小安DL U, Yong以Andy UI來了, Alan land Zhang, C好意and CAI, Wei東and Zhou, Z on各位_
...
-   [\[媒體2019\]](https://www.sciencedirect.com/science/article/pii/S1361841518302640)**F-Anogan：使用生成對抗網絡快速無監督的異常檢測**[：Octocat：](https://github.com/A03ki/f-AnoGAN)

    _Slugs，Thomas和Silfel，Philipp和Waldstin，Sebastian M和Longs，Georg和Smurten，Ursula，Ursula，Ursula，Ursula，Ursula_
...
-   [\[IPMI 2017\]](https://link.springer.com/chapter/10.1007/978-3-319-59050-9_12)**使用生成對抗網絡無監督的異常檢測，以指導標記發現**[：Octocat：](https://github.com/seungjunlee96/AnoGAN-pytorch)

_Slippel，Thomas和Sillek，Philipp和Waldstin，Sebastian M和Small-Enlidth，Ursula和Lakes，Georg_
...
## 6。基於流的方法<div id = "s6"></div>

-   \*[\[CV PR 2023\]](https://openaccess.thecvf.com/content/CVPR2023/html/Lei_PyramidFlow_High-Resolution_Defect_Contrastive_Localization_Using_Pyramid_Normalizing_Flow_CVPR_2023_paper.html?ref=https://githubhelp.com)**金字塔流：使用金字塔歸一化流量的高分辨率缺陷對比度定位**[：Octocat：](https://github.com/gasharper/PyramidFlow)

    _lei, J IA瑞and hu, ξ奧博and Wang, Y UE and l IU, dong_
...
## 7。基於擴散的方法<div id = "s7"></div>

-   [\[CV PR 2025\]](https://arxiv.org/abs/2406.01078)**異常事物：迅速看不見的視覺異常產生**[：Octocat：](https://github.com/EPFL-IMOS/AnomalyAny)

    _sun, Han and CA哦, Y UN抗and dong, ha OA NDF ink, Olga_
...
-   [\[WACV 2025\]](https://www.researchgate.net/profile/Sudipta-Roy-9/publication/389540571_Self-Supervised_Anomaly_Segmentation_via_Diffusion_Models_with_Dynamic_Transformer_UNet/links/67c6e067461fb56424f04c9f/Self-Supervised-Anomaly-Segmentation-via-Diffusion-Models-with-Dynamic-Transformer-UNet.pdf)**通過動態變壓器UNET的擴散模型進行自我監督的異常分割**[：Octocat：](https://github.com/MAXNORM8650/Annotsim)

    _Kumar，Komal＆Chakraborty，Snehishis和Mahapatra，Dwarkanath和Bojorgabar，Bezad＆Roy，Sudipta_
...
_Fontanella，Alessandro和Mair，Grant和Wardlaw，Joanna和Trucco，Emanuele和Storkey，Amos_
...
_Bercea，Cosmin I和Wiestler，Benedikt和Rueckert，Daniel和Schnabel，Julia A_
...
-   [\[不確定2024\]](https://link.springer.com/chapter/10.1007/978-3-031-73158-7_11)**圖像條件的擴散模型用於醫學異常檢測**

    _Baugh，Matthew和Reynaud，Hadrien和Marimont，Sergio Naval和Cechnicka，Sarah和M {\\“ U} Ller，Johanna P和Tarroni，Giacomo和Kainz，Bernhard_
...
-   [\[CV PR 2022\]](https://openaccess.thecvf.com/content/CVPR2022W/NTIRE/papers/Wyatt_AnoDDPM_Anomaly_Detection_With_Denoising_Diffusion_Probabilistic_Models_Using_Simplex_CVPRW_2022_paper.pdf)**陽極：使用單純形噪聲的脫氧擴散概率模型的異常檢測**[：Octocat：](https://github.com/julian-wyatt/anoddpm)

    _懷亞特（Wyatt），朱利安（Julian）和里奇（Leach），亞當（Adam）和施蒙（Schmon），塞巴斯蒂安（Sebastian）_
...
_Wolleb，Julia和Bieder，Florentin和Sandkühler，Robin和Cattin，Philippe C_
...
## 8。基於補丁的方法<div id = "s8"></div>

-   [\[MIDL 2024\]](https://proceedings.mlr.press/v227/behrendt24a/behrendt24a.pdf)**修補的擴散模型，用於腦MRI中無監督的異常檢測**[：Octocat：](https://github.com/finnbehrendt/patched-diffusion-models-uad)

    _Behrendt，Finn和Bhattcharya，Debayan和Krüger，Julia和受害者，Roland和Schlaefer，Alexander_
...
-   \*[\[CV PR 2021\]](https://openaccess.thecvf.com/content/CVPR2021/html/Wang_Glancing_at_the_Patch_Anomaly_Localization_With_Global_and_Local_CVPR_2021_paper.html?ref=https://githubhelp.com)**瞥了一眼貼片：具有全球和局部功能比較的異常定位**

    _Wang, S很值and W U, l i位and C UI, l EIA NDS很, Y U君_
...
## 9。多模式融合<div id = "s9"></div>

-   [\[Inf。 Fusion 2025\]](https://www.sciencedirect.com/science/article/pii/S1566253524004093)**適應多模式視網膜異常檢測和定位的段的任何模型**[：Octocat：](https://github.com/Jingtao-Li-CVer/MMRAD)

    _l i, jin G套and Chen, ting and Wang, X in語and z洪, y按非按D ξ奧, X u按_
...
_long, Kai方案DX IE, GU o樣and MA, l Ian駁岸DL IU, J IA期and l U, Z Hi潮_
...
-   [\[CV PR 2025\]](https://arxiv.org/pdf/2503.06661)**AA-CLIP：通過異常夾提高零射擊異常檢測**[：Octocat：](https://github.com/mwxinnn/aa-clip)

    _MA, wen馨and Zhang, X u Andy奧, Qing松and tang, Fe ng和and W U, Chen須按DLI, ying太Andy按, Ru Ian的Jiang, Z i行and Zhou, s Kevin_
...
-   [\[mic CAI 2025\]](https://arxiv.org/abs/2503.01020)**通過醫學視覺語言模型深入研究分佈式檢測**[：Octocat：](https://github.com/pyjulie/medical-vlms-ood-detection)

    _J U, lie and Zhou, SI級NAND Zhou, Y U酷NAND l U, Hui民and Z虎, Z貨婷and Keane, pear sea and GE, Z on官員_
...
-   [\[神經2024\]](https://proceedings.neurips.cc/paper_files/paper/2024/hash/8f4477b086a9c97e30d1a0621ea6b2f5-Abstract-Conference.html)**一到正常：用於幾次異常檢測的異常個性化**

    _l i, Y i樂and Zhang, S好聽and l i, K昂and Lao, Q I澄_
...
-   [\[CV PR 2024\]](http://openaccess.thecvf.com/content/CVPR2024/papers/Zhu_Toward_Generalist_Anomaly_Detection_via_In-context_Residual_Learning_with_Few-shot_CVPR_2024_paper.pdf)**通過少量樣本提示，通過圍內剩餘學習朝向通才異常檢測**[：Octocat：](https://github.com/mala-lab/inctrl)

    _Z虎, J IA問and pang, guan送_
...
_Huang, C好奇NAND Jiang, AO翻案DF Eng, jin剛好and Zhang, ya and Wang, X in潮and Wang, Y暗諷_
...
-   [\[ICLR 2024\]](https://openreview.net/forum?id=buC4E91xZE)**呼吸症：零射異常檢測的對像不合時宜**[：Octocat：](https://github.com/zqhang/anomalyclip)

    _Zhou, Q i行and pang, guan送and TI按, yuan的he, shi博and Chen, Jim ing_
...
-   \*[\[ACM MM 2024\]](https://dl.acm.org/doi/abs/10.1145/3664647.3681376)**SIMCLIP：簡單提示的圖像文本對準零 - 零/少數異常檢測**[：Octocat：](https://github.com/CH-ORGI/SimCLIP)

    _Deng, Cheng毫安DX U, H奧特and Chen, ξ AO潞安DX U, H奧迪and TU, ξ奧通and ding, xing好and Huang, Y UE_
...
-   [\[mic CAI 2024\]](https://arxiv.org/pdf/2405.11315)**Mediclip：調整剪輯以進行幾次醫療圖像異常檢測**[：Octocat：](https://github.com/cnulab/mediclip)

    _Zhang, ξ秒and X U, min and Q IU, D E會Andy按, R UI欣and Lang, n ing and Zhou, ξ U狀_
...
-   \*[\[神經2022\]](https://proceedings.neurips.cc/paper_files/paper/2022/hash/e43a33994a28f746dcfd53eb51ed3c2d-Abstract-Conference.html)**通過視覺語言表示探索分佈式檢測**[：Octocat：](https://github.com/deeplearning-wisc/mcm)

    _Ming, Y i菲and CAI, Z i樣and GU, J IU像and sun, Y i油and l i, Wei and l i, Y i宣_
...
## 11。知識蒸餾<div id = "s11"></div>

-   \*[\[AA AI 2025\]](https://arxiv.org/pdf/2412.07579)**解鎖反向蒸餾以進行異常檢測的潛力**[：Octocat：](https://github.com/hito2448/urd)

    _l IU, ξ紐約and Wang, J Ian元and Len G, BI AO and Zhang, S貨_
...
## 12。相關學習<div id = "s12"></div>

-   [\[TMI 2024\]](https://ieeexplore.ieee.org/document/10680612)**面對相似性的差異：胸部X射線異常檢測的內部和相互關係的無監督學習**

    _X U, shi成安DL i, Wei and l i, Z UO用and Zhao, tie送and Zhang, Bob_
...
## 13。異常產生<div id = "s13"></div>

-   \*[\[CV PR 2025\]](https://openaccess.thecvf.com/content/CVPR2025/html/Jin_Dual-Interrelated_Diffusion_Model_for_Few-Shot_Anomaly_Image_Generation_CVPR_2025_paper.html)**幾次異常圖像產生的雙間隔擴散模型**[：Octocat：](https://github.com/yinyjin/DualAnoDiff)

    _Jin, Ying and Peng, Jinlong and He, Qingdong and Hu, Teng and Wu, Jiafu and Chen, Hao and Wang, Haoxuan and Zhu, Wenbing and Chi, Mingmin and Liu, Jun and others_
...
## 14。基準<div id = "s14"></div>

-   [\[自然通訊2025\]](https://www.nature.com/articles/s41467-025-56321-y)**評估生成AI中的規範表示學習，以在腦成像中進行健壯的異常檢測**[：Octocat：](https://github.com/compai-lab/2024-ncomms-bercea.git)
...
-   [\[媒體2025\]](https://arxiv.org/pdf/2404.04518)**中間：醫學圖像中異常檢測的比較研究**[：Octocat：](https://github.com/caiyu6666/medianomaly)

    _CAI, yuan的Zhang, Wei問and Chen, H AO and Cheng, K王-ting_
...
-   [\[CV PR 2024\]](https://openaccess.thecvf.com/content/CVPR2024W/VAND/html/Bao_BMAD_Benchmarks_for_Medical_Anomaly_Detection_CVPRW_2024_paper.html)**BMAD：醫療異常檢測的基準**[：Octocat：](https://github.com/dorisbao/bmad)

    _B傲, jin A NAND sun, Han是and Deng, Han求an的he, yin聲and Zhang, Z好像and l i, xing欲_
...
-   [\[Arxiv 2024\]](https://www.researchgate.net/profile/Haoyang-He-7/publication/381190391_ADer_A_Comprehensive_Benchmark_for_Multi-class_Visual_Anomaly_Detection/links/66dffcb7f84dd1716ce10dc4/ADer-A-Comprehensive-Benchmark-for-Multi-class-Visual-Anomaly-Detection.pdf)**ADER：多級視覺異常檢測的綜合基準**[：Octocat：](https://github.com/zhangzjn/ader)

    _Zhang, Jiang寧and he, H澳洋and Gan, Z很也and he, Qing東and CAI, Y u懸案DX UE, Z虎Cu NAND Wang, ya表and Wang, Cheng結案DX IE, LE Ian DL IU, Yong_
